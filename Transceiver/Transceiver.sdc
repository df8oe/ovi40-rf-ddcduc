...
create_clock -name {i2s_master_clocks:i2s_master_clocks|BCLK} -period 1.000 -waveform { 0.000 0.500 } [get_registers {i2s_master_clocks:i2s_master_clocks|BCLK}]
create_clock -name {i2s_master_clocks:i2s_master_clocks|div2_negedge:div32|div_clk} -period 1.000 -waveform { 0.000 0.500 } [get_registers {i2s_master_clocks:i2s_master_clocks|div2_negedge:div32|div_clk}]
create_clock -name {i2s_master_clocks:i2s_master_clocks|div2_negedge:div16|div_clk} -period 1.000 -waveform { 0.000 0.500 } [get_registers {i2s_master_clocks:i2s_master_clocks|div2_negedge:div16|div_clk}]
create_clock -name {i2s_master_clocks:i2s_master_clocks|div2_negedge:div8|div_clk} -period 1.000 -waveform { 0.000 0.500 } [get_registers {i2s_master_clocks:i2s_master_clocks|div2_negedge:div8|div_clk}]
create_clock -name {i2s_master_clocks:i2s_master_clocks|div2_negedge:div4|div_clk} -period 1.000 -waveform { 0.000 0.500 } [get_registers {i2s_master_clocks:i2s_master_clocks|div2_negedge:div4|div_clk}]
create_clock -name {i2s_master_clocks:i2s_master_clocks|div2_negedge:div2|div_clk} -period 1.000 -waveform { 0.000 0.500 } [get_registers {i2s_master_clocks:i2s_master_clocks|div2_negedge:div2|div_clk}]
...
set_clock_uncertainty -rise_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div16|div_clk}] -hold 0.070  
set_clock_uncertainty -rise_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div8|div_clk}] -setup 0.100  
set_clock_uncertainty -rise_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div8|div_clk}] -hold 0.070  
set_clock_uncertainty -rise_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div8|div_clk}] -setup 0.100  
set_clock_uncertainty -rise_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div8|div_clk}] -hold 0.070  
set_clock_uncertainty -rise_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div4|div_clk}] -setup 0.100  
set_clock_uncertainty -rise_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div4|div_clk}] -hold 0.070  
set_clock_uncertainty -rise_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div4|div_clk}] -setup 0.100  
set_clock_uncertainty -rise_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div4|div_clk}] -hold 0.070  
set_clock_uncertainty -rise_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div2|div_clk}] -setup 0.100  
set_clock_uncertainty -rise_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div2|div_clk}] -hold 0.070  
set_clock_uncertainty -rise_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div2|div_clk}] -setup 0.100  
set_clock_uncertainty -rise_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div2|div_clk}] -hold 0.070  
...
set_clock_uncertainty -fall_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div16|div_clk}] -hold 0.070  
set_clock_uncertainty -fall_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div8|div_clk}] -setup 0.100  
set_clock_uncertainty -fall_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div8|div_clk}] -hold 0.070  
set_clock_uncertainty -fall_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div8|div_clk}] -setup 0.100  
set_clock_uncertainty -fall_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div8|div_clk}] -hold 0.070  
set_clock_uncertainty -fall_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div4|div_clk}] -setup 0.100  
set_clock_uncertainty -fall_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div4|div_clk}] -hold 0.070  
set_clock_uncertainty -fall_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div4|div_clk}] -setup 0.100  
set_clock_uncertainty -fall_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div4|div_clk}] -hold 0.070  
set_clock_uncertainty -fall_from [get_clocks {p10M|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div2|div_clk}] -setup 0.100  
...
set_clock_uncertainty -fall_from [get_clocks {i2s_master_clocks:i2s_master_clocks|div2_negedge:div2|div_clk}] -fall_to [get_clocks {i2s_master_clocks:i2s_master_clocks|BCLK}]  0.010  
...
set_clock_uncertainty -rise_from [get_clocks {Receiver:rx|firX8R8:fir2|wstate[0]}] -rise_to [get_clocks {i2s_master_clocks:i2s_master_clocks|BCLK}]  0.020  
set_clock_uncertainty -rise_from [get_clocks {Receiver:rx|firX8R8:fir2|wstate[0]}] -fall_to [get_clocks {i2s_master_clocks:i2s_master_clocks|BCLK}]  0.020  
...
set_clock_uncertainty -fall_from [get_clocks {Receiver:rx|firX8R8:fir2|wstate[0]}] -rise_to [get_clocks {i2s_master_clocks:i2s_master_clocks|BCLK}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {Receiver:rx|firX8R8:fir2|wstate[0]}] -fall_to [get_clocks {i2s_master_clocks:i2s_master_clocks|BCLK}]  0.020  

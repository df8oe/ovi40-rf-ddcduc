## Generated SDC file "RFBoard0.sdc"
...
## DATE    "Tue Mar  9 07:48:17 2021"

##
## DEVICE  "10CL010ZU256I8G"
##
...
create_generated_clock -name {trx|prx|altpll_component|auto_generated|pll1|clk[1]} -source [get_pins {trx|prx|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50/1 -multiply_by 8 -divide_by 25 -master_clock {adc_clock} [get_pins {trx|prx|altpll_component|auto_generated|pll1|clk[1]}] 
...
set_clock_uncertainty -rise_from [get_clocks {transceiver:trx|Transmitter:tx|cdc_sync:p_clk|sigb[0]}] -rise_to [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] -setup 0.060  
set_clock_uncertainty -rise_from [get_clocks {transceiver:trx|Transmitter:tx|cdc_sync:p_clk|sigb[0]}] -rise_to [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] -hold 0.090  
set_clock_uncertainty -rise_from [get_clocks {transceiver:trx|Transmitter:tx|cdc_sync:p_clk|sigb[0]}] -fall_to [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] -setup 0.060  
set_clock_uncertainty -rise_from [get_clocks {transceiver:trx|Transmitter:tx|cdc_sync:p_clk|sigb[0]}] -fall_to [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] -hold 0.090  
set_clock_uncertainty -fall_from [get_clocks {transceiver:trx|Transmitter:tx|cdc_sync:p_clk|sigb[0]}] -rise_to [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] -setup 0.060  
set_clock_uncertainty -fall_from [get_clocks {transceiver:trx|Transmitter:tx|cdc_sync:p_clk|sigb[0]}] -rise_to [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] -hold 0.090  
set_clock_uncertainty -fall_from [get_clocks {transceiver:trx|Transmitter:tx|cdc_sync:p_clk|sigb[0]}] -fall_to [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] -setup 0.060  
set_clock_uncertainty -fall_from [get_clocks {transceiver:trx|Transmitter:tx|cdc_sync:p_clk|sigb[0]}] -fall_to [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] -hold 0.090  
...
set_clock_uncertainty -rise_from [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {transceiver:trx|Transmitter:tx|cdc_sync:p_clk|sigb[0]}] -setup 0.090  
set_clock_uncertainty -rise_from [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {transceiver:trx|Transmitter:tx|cdc_sync:p_clk|sigb[0]}] -hold 0.060  
set_clock_uncertainty -rise_from [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {transceiver:trx|Transmitter:tx|cdc_sync:p_clk|sigb[0]}] -setup 0.090  
set_clock_uncertainty -rise_from [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {transceiver:trx|Transmitter:tx|cdc_sync:p_clk|sigb[0]}] -hold 0.060  
...
set_clock_uncertainty -fall_from [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {transceiver:trx|Transmitter:tx|cdc_sync:p_clk|sigb[0]}] -setup 0.090  
set_clock_uncertainty -fall_from [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {transceiver:trx|Transmitter:tx|cdc_sync:p_clk|sigb[0]}] -hold 0.060  
set_clock_uncertainty -fall_from [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {transceiver:trx|Transmitter:tx|cdc_sync:p_clk|sigb[0]}] -setup 0.090  
set_clock_uncertainty -fall_from [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {transceiver:trx|Transmitter:tx|cdc_sync:p_clk|sigb[0]}] -hold 0.060  

## Generated SDC file "RFBoard2.sdc"
...
create_clock -name {adc1_clock} -period 6.510 -waveform { 0.000 3.255 } [get_ports {adc1_clock}]
...
create_generated_clock -name {trx|prx|altpll_component|auto_generated|pll1|clk[0]} -source [get_pins {trx|prx|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50/1 -multiply_by 1 -phase 270/1 -master_clock {adc1_clock} [get_pins {trx|prx|altpll_component|auto_generated|pll1|clk[0]}] 
create_generated_clock -name {trx|prx|altpll_component|auto_generated|pll1|clk[1]} -source [get_pins {trx|prx|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50/1 -multiply_by 4 -divide_by 25 -master_clock {adc1_clock} [get_pins {trx|prx|altpll_component|auto_generated|pll1|clk[1]}] 
create_generated_clock -name {trx|prx|altpll_component|auto_generated|pll1|clk[2]} -source [get_pins {trx|prx|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50/1 -multiply_by 1 -phase 90/1 -master_clock {adc1_clock} [get_pins {trx|prx|altpll_component|auto_generated|pll1|clk[2]}] 
...
set_clock_uncertainty -rise_from [get_clocks {adc1_clock}] -rise_to [get_clocks {adc1_clock}]  0.020  
set_clock_uncertainty -rise_from [get_clocks {adc1_clock}] -fall_to [get_clocks {adc1_clock}]  0.020  
set_clock_uncertainty -rise_from [get_clocks {adc1_clock}] -rise_to [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[2]}] -setup 0.070  
set_clock_uncertainty -rise_from [get_clocks {adc1_clock}] -rise_to [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[2]}] -hold 0.100  
set_clock_uncertainty -rise_from [get_clocks {adc1_clock}] -fall_to [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[2]}] -setup 0.070  
set_clock_uncertainty -rise_from [get_clocks {adc1_clock}] -fall_to [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[2]}] -hold 0.100  
set_clock_uncertainty -fall_from [get_clocks {adc1_clock}] -rise_to [get_clocks {adc1_clock}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {adc1_clock}] -fall_to [get_clocks {adc1_clock}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {adc1_clock}] -rise_to [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[2]}] -setup 0.070  
set_clock_uncertainty -fall_from [get_clocks {adc1_clock}] -rise_to [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[2]}] -hold 0.100  
set_clock_uncertainty -fall_from [get_clocks {adc1_clock}] -fall_to [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[2]}] -setup 0.070  
set_clock_uncertainty -fall_from [get_clocks {adc1_clock}] -fall_to [get_clocks {trx|prx|altpll_component|auto_generated|pll1|clk[2]}] -hold 0.100  
